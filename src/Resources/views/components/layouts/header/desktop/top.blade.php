...
<v-topbar>
    <!-- Shimmer Effect -->
    <div class="flex items-center justify-between bg-surface-base px-16 text-content-primary">
        <!-- Currencies -->
...
@pushOnce('scripts')
    ...
    >
        <div class="flex w-full items-center justify-between bg-surface-base px-16 text-content-primary">
